              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="hapus.php?id=<?php echo $d['id_user']; ?>" class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus data ini?')" ><i class="fas fa-trash"></i ></a>

                        <a href="" id="edit_user" data-toggle="modal" data-target="#edit" data-id="<?php echo $d['id_user']; ?>" ><button class="btn btn-primary"><i class="fas fa-edit"></i></button></a>
