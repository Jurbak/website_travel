              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php 
                        include '../../../koneksi.php';
                        $data = mysqli_query($conn,"select * from tbl_pesan");
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="hapus.php?id=<?php echo $d['id_pesan']; ?>" class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus data ini?')" ><i class="fas fa-trash"></i ></a>

                        <a href="" id="edit_travel" data-toggle="modal" data-target="#edit" data-id="<?php echo $d['id_pesan']; ?>" ><button class="btn btn-primary"><i class="fas fa-edit"></i></button></a>
